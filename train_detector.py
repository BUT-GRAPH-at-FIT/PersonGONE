...
parser.add_argument('--epochs', type=int, default=75, help='count of training epochs')
...
shutil.move(os.path.join('YOLOX_outputs', args.experiment_name, 'best_ckpt.pth'), os.path.join(final_path, 'best_ckpt_pth'))
shutil.rmtree(os.path.join('YOLOX_outputs', args.experiment_name))
